import type { CalendarTypes } from "../gregorian-julian/ct-type.js";
import { gregorian2Julian } from "../gregorian-julian/gregorianTojulian.js";
import { uniqNumber, uniqString } from "../helpers/index.js";
import { isLeapYear, monthsDaysArray } from "../helpers/index.js";
...
export class Calendar {
   ...
   */
  private MONTH_SHORT = this.MONTHS.map((i) =>
  ...
  private cal() {
    ...
    for (let i = 0; i < 12; i++) {
      ...
      for (let j = 1; j <= days_in_month; j++) {
        const _month = i + 1;
        // get jdn
        const jdn: number = gregorian2Julian({
          year: this._year,
          month: _month,
          day: j,
          timeZone: this._tz,
