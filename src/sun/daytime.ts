 ...
 */
const timeDiff = function (decimalTime1: number, decimalTime2: number): string {
 ...
 */
const convertDecimalTime = function (decimalTime: number): string {
...
export const getDayTime = function (
  latitude: number,
  longitude: number,
  timezone?: TimeZones
) {
