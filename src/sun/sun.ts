 ...
 *
 * This function computes the local times of sunrise and sunset based on
 * the provided latitude, longitude, and optional timezone. The calculations
 * are based on solar positioning and astronomical formulas.
 *
 ...
 * @returns An array containing the local time of sunrise and sunset. If
 *          the sun does not rise or set on that day, null is returned
